...
export const sectionHeadingClass =
  "mt-5 text-4xl font-extrabold tracking-[-0.02em] leading-[1.1] sm:text-5xl lg:text-[56px]";
...
export const sectionSubheadingClass =
  "text-[15px] leading-relaxed text-[#6B7280] sm:text-base";

export const sectionSubheadingDark =
  "text-[15px] leading-relaxed text-white/45 sm:text-base";
